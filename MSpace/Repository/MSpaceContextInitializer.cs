...
namespace MSpace.Repository
{
    ...
    /// 摘要
    /// </summary>
    //public class MSpaceContextInitializer : DropCreateDatabaseIfModelChanges<MSpaceContext>
    public class MSpaceContextInitializer : DropCreateDatabaseAlways<MSpaceDB>
    //public class MSpaceContextInitializer : MigrateDatabaseToLatestVersion<MSpaceContext, MSpaceContextConfiguration>
    {
